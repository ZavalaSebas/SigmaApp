...
class RecuperarContraWidget extends StatefulWidget {
  const RecuperarContraWidget({super.key});
...
class _RecuperarContraWidgetState extends State<RecuperarContraWidget> {
  ...
  void initState() {
    ...
    _model.txtRecuperarPassController ??= TextEditingController();
    _model.txtRecuperarPassFocusNode ??= FocusNode();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: _model.txtRecuperarPassController,
                    focusNode: _model.txtRecuperarPassFocusNode,
                    autofocus: true,
                    obscureText: false,
                    ...
                    validator: _model.txtRecuperarPassControllerValidator
                        .asValidator(context),
                  ),
                ),
                Padding(
