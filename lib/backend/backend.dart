...
import 'schema/formulario_sap_record.dart';
...
export 'schema/formulario_sap_record.dart';
...
/// Functions to query FormularioSapRecords (as a Stream and as a Future).
Future<int> queryFormularioSapRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FormularioSapRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FormularioSapRecord>> queryFormularioSapRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FormularioSapRecord.collection,
      FormularioSapRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FormularioSapRecord>> queryFormularioSapRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
